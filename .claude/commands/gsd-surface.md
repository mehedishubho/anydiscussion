...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Devsroom-Work/anydiscussion/.claude/.gsd-surface.json`
(sibling to `D:/Devsroom-Work/anydiscussion/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `D:/Devsroom-Work/anydiscussion/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`D:/Devsroom-Work/anydiscussion/.claude/skills`).
...
`D:/Devsroom-Work/anydiscussion/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `D:/Devsroom-Work/anydiscussion/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `D:/Devsroom-Work/anydiscussion/.claude/.gsd-surface.json`
Install profile marker: `D:/Devsroom-Work/anydiscussion/.claude/.gsd-profile`
Skill dirs: `D:/Devsroom-Work/anydiscussion/.claude/skills/gsd-*/`
Engine module: `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
