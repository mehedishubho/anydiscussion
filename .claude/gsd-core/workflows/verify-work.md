...
<template>
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/workflows/transition.md`.
...
- Follow @D:/Devsroom-Work/anydiscussion/.claude/gsd-core/workflows/diagnose-issues.md
