...
```
Agent(
  prompt="Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/SECURITY.md`
