...
INSTALL_JS_GLOBAL="D:/Devsroom-Work/anydiscussion/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Devsroom-Work/anydiscussion/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
