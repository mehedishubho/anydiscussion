...
ones). Reference: @D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/Devsroom-Work/anydiscussion/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/Devsroom-Work/anydiscussion/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/Devsroom-Work/anydiscussion/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/spec.md.
