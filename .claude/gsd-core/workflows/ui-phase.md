...
```markdown
Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-ui-checker.md for instructions.
