...
<required_reading>
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/ai-frameworks.md
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Devsroom-Work/anydiscussion/.claude/agents/gsd-eval-planner.md for instructions.
