...
- Usage: Reference from command with `@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/Devsroom-Work/anydiscussion/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Devsroom-Work/anydiscussion/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
