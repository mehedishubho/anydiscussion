...
<!-- For checkpoint task examples and patterns, see @D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
