...
<required_reading>
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/Devsroom-Work/anydiscussion/.claude
                  → checks D:/Devsroom-Work/anydiscussion/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/Devsroom-Work/anydiscussion/.claude/gsd-core
                  → writes to D:/Devsroom-Work/anydiscussion/.claude/gsd-core/hooks/
...
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/common-bug-patterns.md
