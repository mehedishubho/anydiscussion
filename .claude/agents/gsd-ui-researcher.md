...
Use template from `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/UI-SPEC.md`
