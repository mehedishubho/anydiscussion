...
Reference full template: `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/templates/state.md`.
