...
<reference>
@D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Devsroom-Work/anydiscussion/.claude/gsd-core/references/user-profiling.md` to load:
