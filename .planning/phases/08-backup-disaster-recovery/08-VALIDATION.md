...
| 08-04-1 | 04 | 3 | BACKUP-05 | T-08-04 | Every action calls requireRole('admin') FIRST; getBackupSettings redacts secrets | unit | `pnpm test -- --run src/actions/__tests__/backup-settings.test.ts` | ❌ W0 | ⬜ pending |
